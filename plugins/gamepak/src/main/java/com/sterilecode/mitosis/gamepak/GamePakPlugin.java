...
import com.sterilecode.mitosis.gamepak.view.provider.PluginViewProvider;
...
public class GamePakPlugin implements IPlugin {
  ...
  public void activate(IPluginRegistry contract) {
    contract.registerObject(Constants.VIEW_PROVIDER_SERVICE_ID, PluginViewProvider.getInstance());
